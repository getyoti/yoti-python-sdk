...
class RequiredShareCode(RequiredDocument):
    """
    Represents a required share code resource for a session
    """
    ...
    def type(self):
        """
        Returns the type of required document
    ...
    def issuer(self):
        """
        Returns the issuer of the share code
    ...
    def scheme(self):
        """
        Returns the scheme of the share code
...
class RequiredShareCodeBuilder(object):
    ...
    Example::
        ...
        required_share_code = (RequiredShareCodeBuilder()
                               .with_issuer("some_issuer")
                               .with_scheme("some_scheme")
                               .build())
    ...
    def with_issuer(self, issuer):
        """
        Sets the issuer on the required share code
    ...
    def with_scheme(self, scheme):
        """
        Sets the scheme on the required share code
